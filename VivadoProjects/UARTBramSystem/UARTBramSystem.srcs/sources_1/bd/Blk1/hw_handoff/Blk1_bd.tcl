...
################################################################
# This is a generated script based on design: Blk1
#
...
proc create_root_design { parentCell } {
  ...
  set ledOut [ create_bd_port -dir O -from 3 -to 0 ledOut ]
  set rst [ create_bd_port -dir I rst ]
  set rxSignal [ create_bd_port -dir I rxSignal ]
  set txSignal [ create_bd_port -dir O txSignal ]

  # Create instance: Combiner_0, and set properties
  set block_name Combiner
  set block_cell_name Combiner_0
  if { [catch {set Combiner_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Combiner_0 eq "" } {
  ...
  connect_bd_net -net Combiner_0_addressVal [get_bd_pins Combiner_0/addressVal] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net Combiner_0_dataOut [get_bd_pins Combiner_0/dataOut] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net Combiner_0_ledOut [get_bd_ports ledOut] [get_bd_pins Combiner_0/ledOut]
  connect_bd_net -net Combiner_0_txSignal [get_bd_ports txSignal] [get_bd_pins Combiner_0/txSignal]
  connect_bd_net -net Combiner_0_we [get_bd_pins Combiner_0/we] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net Net [get_bd_ports clk] [get_bd_pins Combiner_0/clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins blk_mem_gen_0/doutb]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins Combiner_0/rst]
  ...
  connect_bd_net -net rxSignal_1 [get_bd_ports rxSignal] [get_bd_pins Combiner_0/rxSignal]
