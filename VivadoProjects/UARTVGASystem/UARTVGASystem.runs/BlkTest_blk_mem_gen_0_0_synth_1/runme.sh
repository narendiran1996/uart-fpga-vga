...
HD_PWD='/mnt/18C846EDC846C928/UARTVGASystem/VivadoProjects/UARTVGASystem/UARTVGASystem.runs/BlkTest_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlkTest_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlkTest_blk_mem_gen_0_0.tcl
