...
HD_PWD='/mnt/18C846EDC846C928/UARTVGASystem/VivadoProjects/UARTVGASystem/UARTVGASystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlkTest_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlkTest_wrapper.tcl
